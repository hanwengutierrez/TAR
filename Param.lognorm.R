...
#' @return 
#' The autoregressive coefficients matrix theta and variance weights \eqn{H}. Rows of the matrix theta represent regimes
#' @details
...
#' @param \eqn{K} The vector containing the autoregressive orders of the l regimes.
...
Param.lognorm <- function(Z, X, l, r, K, n.sim=500, p.burnin=0.2, n.thin=3){
  if(length(r)!=(l-1))
